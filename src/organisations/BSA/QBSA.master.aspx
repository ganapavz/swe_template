...
<%@ Register TagName="InsertHTMLFile" TagPrefix="uc" src="~/_controltemplates/InsertHTMLFileUserControl.ascx"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html lang="<%$Resources:wss,language_value%>" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns="http://www.w3.org/1999/xhtml" runat="server" dir="<%$Resources:wss,multipages_direction_dir_value%>" __expr-val-dir="ltr">
<head runat="server">
	...
	<!-- adding custom stylesheet for tweaking out of box styles-->
	<SharePoint:CssRegistration name="/Style Library/bsa_assets/style/QBSA.css" After="minimalv4.css" runat="server"/>	
	<!--adding SSQ header containing link to other CSS and javascript files -->
	<uc:InsertHTMLFile FilePath="/style library/assets/includes/global/head-assets.html" ID="headassetsid" runat="server"/>
...
<body onload="javascript:if (typeof(_spBodyOnLoadWrapper) != 'undefined') {_spBodyOnLoadWrapper();moveSearchBox();}" class="residents" id="qld-gov-au"><!--updated body tag with class and id attributes-->
	<form runat="server" onsubmit="if (typeof(_spFormOnSubmitWrapper) != 'undefined') {return _spFormOnSubmitWrapper();} else {return true;}">
	<!-- adding header text provided by SSQ -->
	<div>
   		<uc:InsertHTMLFile FilePath="/style library/assets/includes/global/header.html" ID="someid" runat="server"/>
   	</div>
   	<!-- search box loads from delegate, style with CSS -->
   	<div id="search-orig-wrap">
		<div class="s4-notdlg">
	...
	<!--encapsulating spans and a tags with div to make it XHTML compliant-->
	<div>
	...
	<!--encapsulated content in required SSQ template-->
	...
	<!--hidding additional/unneeded elements-->
	<asp:Panel runat="server" Visible="false">
	...
	<!--adding footer provided by SSQ-->
	<div>
   		<uc:InsertHTMLFile FilePath="/style library/assets/includes/global/footer-page.html" ID="footerpageid" runat="server"/>
   		<uc:InsertHTMLFile FilePath="/style library/assets/includes/global/footer-stats.html" ID="footerstatsid" runat="server"/>
   	</div>
   	<script type="text/javascript"><!--
		function moveSearchBox(){
			$('#search-wrap').append($('#search-orig-wrap').contents());
			$('#search-orig-wrap').remove();
		}
   	//--></script>
</body>
</html>
