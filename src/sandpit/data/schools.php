...
<head>
	...
	<title>Schools directory | FRANCHISE | Queensland Government</title>

<!--#set var="franchise" value=""-->
<!--#set var="title" value="Schools directory"-->
...
<style type="text/css">
	...
	<meta name="DCTERMS.title" content="Schools directory | FRANCHISE" />
	<meta name="DCTERMS.alternative" content="Parking permits" />
...
<?php virtual("/assets/includes/global/breadcrumb-citizen.html") ?>
				<li><a href="/disability/">Education and training</a></li>
				<li class="last-child">Schools directory</li>
			</ol>
		</div>
...
<?php
	...
	$lines = file( 'schools-directory.csv' );
...
<?php
	...
	foreach ( $lines as $line_num => $line ) {
		echo '<tr>';
			...
			echo '<td>' . htmlspecialchars( $data[ 5 ] ) . ' <br />' .
					htmlspecialchars( $data[ 6 ] ) . ' <br />' .
					htmlspecialchars( $data[ 7 ] ) . '</td>'
			;
				...
				<div id="document-properties"><div class="box-sizing">
					<dl>
						...
						<dd id="document-licence">
							<a href="http://creativecommons.org/licenses/by/3.0/au/" rel="license" title="Text available under Creative Commons Attribution-NoDerivs 3.0 Australia (CC BY 3.0) licence"><img src="/assets/v2/images/licences/by-80x15.png" alt="Creative Commons Attribution-NoDerivs 3.0 Australia (CC BY 3.0)"/></a>
						</dd>
